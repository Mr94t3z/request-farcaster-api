...
def fetch_filtered_user_data(user_ids):
...
filtered_user_data = fetch_filtered_user_data(user_ids)
...
file_path = os.path.join(folder_name, "filtered_user_data.json")
with open(file_path, "w") as json_file:
    json.dump(filtered_user_data, json_file, indent=4)
